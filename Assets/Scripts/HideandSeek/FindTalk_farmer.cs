...
public class FindTalk_farmer : MonoBehaviour
{
    ...
    public void StartTalk()
    {
        ...
        if (GameManager.FindRoot == 3 || GameManager.FindRoot == 18 || GameManager.FindRoot == 29 || GameManager.FindRoot == 36 || GameManager.FindRoot == 46)
        {
