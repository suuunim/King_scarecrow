...
public class FindTalk_mainfield : MonoBehaviour
{
    ...
    public void StartTalk()
    {
        ...
        if (GameManager.FindRoot == 6 || GameManager.FindRoot == 13 || GameManager.FindRoot == 21 || GameManager.FindRoot == 34 || GameManager.FindRoot == 48)
        {
