...
public class RField : MonoBehaviour
{
    ...
    public void clickfield()
    {
        ...
        else if(cursorControl.text == "2" && this.GetComponent<Button>().name == "field2" && sp == plowed)
        {

        }

        //파 씨앗 클릭 후 파밭을 클릭하는 경우
        else if (cursorControl.text == "3" && this.GetComponent<Button>().name == "field3" && sp == plowed)
        {
