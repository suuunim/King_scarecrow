...
public class Part1_headhouse : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        script_list_1 = new string[] { "네, "+a+"라고 합니다. 잘 부탁드려요!", "어릴 적부터 시골 마을에서 농사를 지으며 사는 게 꿈이었습니다.", "힘들었던 도시 생활을 접고, 이제 그 꿈을 이뤄보려고 합니다!", "그 꿈 이루도록 내가 많이 도와주지.", "다른 이들과는 인사 안했지? 마을 회관에 있으면 내가 사람들과 함께 가겠네.", "먼저 가있게나." };
