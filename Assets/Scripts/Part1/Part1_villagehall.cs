...
public class Part1_villagehall : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        script_list_1 = new string[] { "안녕하세요! 저는 "+name+"라고 합니다.", "공기 좋은 마을에서 농사를 지으며 살고 싶어, 마을에 내려오게 되었습니다.", "일손이 부족하시면 저를 불러주세요! 마다 않고 달려가겠습니다.", "아직 농사에 대해 잘 몰라, 이웃 분들께서 많이 도와 주시면 감사하겠습니다.", "여러분들과 함께 즐겁게 지내고 싶어요! 잘 부탁드립니다.", "…", "…", "…", "그래요. 이제 다들 해산해도 됩니다. "+name+"씨도 가보세요.", "이 분위기 뭐지.. 내가 뭘 잘못 한 게 있나?", "흐음... 한 분 한 분 직접 찾아가서 인사 드려야겠어.", "농사를 성공적으로 마치려면 그분들의 도움이 꼭 필요해." };
