...
public class Part1_downstairs : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if ((GameManager.Part1 == 3 || GameManager.Part1 == 4 || GameManager.Part1 == 5)&& GameManager.down_check == 0)
        {
            nametagText.text = a;
            t_npc2.transform.gameObject.SetActive(true);
            talk.SetMsg("안녕하세요! 저 아까 마을 회관에서 인사 드린 "+ a+ "입니다.");
