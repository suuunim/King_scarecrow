...
public class Part1_mainhouse : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else if (GameManager.Part1 == 16)
        {
            ...
            mainface.SetActive(true);
            talk.SetMsg("아냐, 우선 차 타고 나가보자. 내 사정을 얘기하고 잘 해결하면 돼지.");
