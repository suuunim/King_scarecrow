...
public class Part1_mainhouse : MonoBehaviour
{
    ...
    GameData gd;
    string[] script_list_1 = new string[] { "귀농했다가 적응 못해서 돌아오기도 한다던데, 그게 내가 되는 건 아니겠지?", "그래도 친해지면 좋으신 분들일 거야. 내가 잘하면 돼지!", " 그런데….. 그 할머님께서 하신 얘기는 뭐였을까. 내가 이 곳을 떠나야 한다고?", "별 일 아닐 거야. 걱정해봤자 할 수 있는 것도 없고.", " 씨앗이고 농기구고 이미 다 샀고, 이만큼 땅값 싼 곳 다시 구하기도 어려워.", " 아휴! 피곤하다. 내일부터는 농사 일 시작해야 하니까… 이제 그만 자자.", "자! 오늘부터 농사 시작이다. 농기구랑 씨앗... 필요한 것들도 다 챙겼어.", "이제 밭으로 가볼까!" };
    ...
    string[] script_list_4 = new string[] { "내가 차 키를.. 뭐야! 왜 차 키가 없어? 설마 이장이 가져 간 건가? ", "이건 아니지… 절도는 대놓고 범죄잖아. 어제 바로 마을을 떠났어야 했어.", "내가 미쳤지. 괜히 남겠다고 다짐해서. 허, 이제 난 어떻게 해야 하지?", "차를 타고 나갈 수도 없고, 휴대폰도 안되고. 완전히 고립돼버렸네.", "저기요, 차 키 찾아요?", "뭐..? 너 혹시! 네가 내 차 키 숨겼니?", "네.", "그거 어디 있어. 당장 내놔!!!!!!!!!!!!!!", "싫은데요.", "차 키 절대 못 찾을 거예요. 내가 당신이라면 찾을 수 없는 곳에 숨겼으니까.", " 그러니 포기해요. 이장한테 반항해봤자 당신만 힘들어져요.", "…", "우리 할머니가 말했을 때, 새겨 들었어야죠. 이제... 돌이킬 수도 없어요.", "농사로 뭘 할 생각도 하지 마요. 어차피 당신은 농사 못 지어요.", "아랫집 사람들이 당신 농기구든 씨앗이든 뭐든 가져갈 거라고 했어요.", "너무 애쓰지 마요.. 당신도 결국 우리처럼 될 거니까. 그럼 수고하세요.", "허..", "하하하하… 다들 제 정신이 아냐. 이 마을은 미쳤어. ", "어떻게든 떠나야 돼. 농사고 뭐고 다 필요 없어. 이러다  나까지 미쳐버릴 거야.", "하아.. 어떻게 떠나야 하지? 도대체 어떻게? 차도 없는데... ", "뛰어 가자. 처음 만나는 사람 하나 붙잡고, 마을 사람들 싹 다 신고해버리자." };
    ...
    void Start()
    {
        ...
        script_list_2 = new string[] { "무 하나에 602원, 배추 하나엔 907원, 파는 1205원이고. ", "이걸 계산하면… "+(602 * gd.raddishNum + 907*gd.cabbageNum + 1205 * gd.greenOnionNum) +"원.", "뭐야! 받은 돈이랑 너무 차이가 나는데? 이거 순 사기 아니야!!!!!!!!!!!!", "이장 미친 거 아냐? 내가 그걸 어떻게 수확했는데! 당장 찾아 가서 따져야겠어." };
